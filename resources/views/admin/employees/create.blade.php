            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('employees.store') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" value="{{ old('first_name') }}"
                                        ...
                                        id="InputFirstname" placeholder="Enter first_name" aria-describedby="NameError"
                                        aria-invalid="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" value="{{ old('last_name') }}"
                                        ...
                                        id="InputLastname" placeholder="Enter last_name" aria-describedby="NameError"
                                        aria-invalid="true">
                                    <span id="NameError" class="error invalid-feedback">
